    ...
    <>
     <div className="container p-6 bg-[#171717] w-full h-screen">
        ...
        <div className="w-full h-96 p-8 bg-[#262626] sm:w-1/2 lg:w-96 md:w-2/5 mx-auto rounded-md">
          <h1 className="text-2xl text-[#61dafb] font-bold text-center">Register - Todo apps</h1>
          <form action="" method="post">
            ...
            <button className="w-full animation duration-500 focus:transition-all focus:duration-500 focus:ring-offset-1 focus:ring-2 focus:ring-[#61dafb] h-10 bg-[#61dafbd6] focus:ring-offet-blue-200 rounded-md mt-4 text-slate-900 font-bold">Register</button>
          </form>
          <p className="text-xs text-white my-4 text-center">
            ALready account? 
            <a href="/login" className="ml-1 text-[#61dafb]">Login</a>
          </p>
        </div>
      </div>
    </>
